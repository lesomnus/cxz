...
func (m *Mutation) SetAgent(s string) {
	m.agent = &s
}

// Agent returns the value of the "agent" field in the mutation.
func (m *Mutation) Agent() (r string, exists bool) {
	v := m.agent
	if v == nil {
		return
	}
...
func (m *Mutation) SetStatus(rs *resource.SessionStatus) {
	m.status = &rs
}

// Status returns the value of the "status" field in the mutation.
func (m *Mutation) Status() (r *resource.SessionStatus, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	case FieldDateCreated:
		...
		return nil
	case FieldStatus:
		v, ok := value.(*resource.SessionStatus)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetStatus(v)
