...
func (m *model) reportActivity() tea.Cmd {
	...
	busy := m.memoryPage != nil || m.settingsPage != nil || m.redactDialog != nil || m.redactSending || m.input.Value() != "" || m.busy || m.workflow != nil || m.creating || m.renaming || m.restartConfirm != nil || m.pasteDialog != nil || time.Since(m.lastUIInput) < 10*time.Second
