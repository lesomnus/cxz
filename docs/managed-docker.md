...
For project containers, use [`cxz edit docker-compose`](devcontainer-overrides.md).
It edits `docker-compose.yaml` beside the settings file; `devcontainer.compose`
can select another path.
